...
#def recommendDrug(disease):
    #global drugDictionary
   # recommended_drug = drugDictionary.get(disease)
    #if recommended_drug:
       # print("We recommend taking", recommended_drug, "for", disease)
     ##   return recommended_drug
   # else:
       # print("Sorry, we do not have a recommendation for", disease)
       # return None
...
def tree_code(tree, feature_names,disease_input=disease_inp):
    ...
    def recurse(node, depth):
        ...
        if tree_.feature[node] != _tree.TREE_UNDEFINED:
            ...
            #disease = 'some disease'  # replace with the name of the disease
            disease=disease_inp
            ...
            #print("The predicted drug is"recommended_drug,"for"disease)

            #print("We recommend taking", recommended_drug, "for", present_disease[0])
            # Define recommended_drug variable
            #recommended_drug = "Aspirin"
            #print()
            #print(i+1,")",j)
            #print("We recommend taking", recommended_drug, "for", present_disease[0])
